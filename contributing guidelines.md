...
* Remember that this is an inclusive community, committed to creating a safe, positive environment.  See the full [Code of Conduct](https://github.com/Catalyst-SMVD/Catalyst/blob/master/Contributing%20Guidelines.md).
* Please consider raising an issue before submitting a pull request (PR) to solve a problem that is not present in our [issue tracker](https://github.com/Catalyst-SMVD/Catalyst/issues). This allows maintainers to first validate the issue you are trying to solve and also reference the PR to a specific issue.
...
* When creating an issue to report a bug in the project, please follow our 
