            ...
            <div class="img__wrap">
                ...
                <p class="img__description">
                    ...
                    <span class="social-icons">
                        ...
                        ></a>
                        <a
                            href="https://github.com/anubhavsingh16"
                            alt="github"
                            target="_blank"
        ...
        <slide :index="1" class="team">
            <div class="img__wrap">
                ...
                <p class="img__description">
                    ...
                    <span class="social-icons">
                        <a
                            href="https://www.linkedin.com/in/pushpinderpalsingh/"
                            alt="linkedin"
                            target="_blank"
                            ><i class="fab fa-linkedin"></i
                        ></a>
                        <a
                            href="https://github.com/pushpinderpalsingh"
                            alt="github"
                            target="_blank"
                            ><i class="fab fa-github-square"></i
                        ></a>
        ...
        <slide :index="3" class="team">
            <div class="img__wrap">
                ...
                <p class="img__description">
                    ...
                    <span class="social-icons">
                        <a
                            href="https://www.linkedin.com/in/aashim-garg-370104198/"
                            alt="linkedin"
                            target="_blank"
                            ><i class="fab fa-linkedin"></i
                        ></a>
                        <a
                            href="https://github.com/aashimgarg"
                            alt="github"
                            target="_blank"
                            ><i class="fab fa-github-square"></i
                        ></a>
        ...
        <slide :index="4" class="team">
            <div class="img__wrap">
                ...
                <p class="img__description">
                    ...
                    <span class="social-icons">
                        <a
                            href="https://www.linkedin.com/in/aman-kumar-6b31b9127/"
                            alt="linkedin"
                            target="_blank"
                            ><i class="fab fa-linkedin"></i
                        ></a>
                        <a
                            href="https://github.com/Amankumar29"
                            alt="github"
                            target="_blank"
                            ><i class="fab fa-github-square"></i
                        ></a>
        ...
        <slide :index="5" class="team">
            <div class="img__wrap">
                ...
                <p class="img__description">
                    <br /><br />
                    <span class="centered">
                        Hrishikesh Agarwal <br />Member</span
                    >
                    <br />
                    <span class="social-icons">
                        <a
        ...
        <slide :index="7" class="team">
            <div class="img__wrap">
                ...
                <p class="img__description">
                    <br /><br />
                    <span class="centered">
                        Bindusar Maurya <br />Contributor</span
                    >
                    <br />
                    <span class="social-icons">
                        <a
        ...
        <slide :index="8" class="team">
            <div class="img__wrap">
                ...
                <p class="img__description">
                    <br /><br />
                    <span class="centered">
                        Hari Sapna Nair <br />Contributor</span
                    >
                    <br />
                    <span class="social-icons">
                        <a
...
.img__description {
    ...
    left: 0;
    right: 0;
    background: rgba(255, 214, 51, 0.4);
