  ...
  <div>
    <footer class="page-footer">
      <div class="footer-content flexdisplay">
        ...
        <div class="fc-right">
          <div class="fc-nav">
            <ul>
              <li>
                <button @click="change1"><a>PRIVACY POLICY</a></button>
              </li>
              <li>
                <button @click="change2"><a>TERMS OF USE</a></button>
              </li>
              <li>
              ...
              <li>
                <button @click="change4"><a>CONTACT US</a></button>
              </li>
            </ul>
          </div>
      ...
      <div class="footer-copyright text-center py-3">
        &copy; Catalyst 2020
        <img
          src="https://anitab.org/wp-content/assets/images/footer_bars.png"
          class="footer-img"
        />
      </div>
    </footer>
